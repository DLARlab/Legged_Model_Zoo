...
assert(isequal(registry.listModels(),expectedIds), ...
    'lmz:Isolation:Models', 'The three canonical models were not discovered.');
...
assert(isequal(guiApp.Controller.modelIds(),expectedIds), ...
    'lmz:Isolation:GUIModels', 'The GUI did not expose all canonical models.');
...
report = struct('Success',true,'Root',root,'ModelIds',{expectedIds}, ...
