...
roundEightMixed={ ...
    ...
    'examples/demo_graphics_comparison_gallery.m', ...
    'examples/demo_research_graphics_recording.m', ...
    'examples/demo_visual_profile_switching.m', ...
    'src/+lmz/+examples/ResearchGraphics.m', ...
    'tests/visualization/TestResearchRenderedImages.m', ...
    'tests/visualization/TestResearchRendererPerformance.m', ...
    'tests/visualization/TestScientificPlotProfiles.m'};
if any(strcmp(relative,roundEightMixed))
    family='mixed';return
end
