classdef SingleStrideProblem < lmz.api.BaseProblem
    ...
    methods
        function obj=SingleStrideProblem(model,configuration)
            ...
            decision=lmzmodels.slip_quad_load.MultiStrideDecisionSchema.create(1,dataset.XAccum);
            ...
            obj.Version='2.0.0';obj.Dataset=dataset;obj.DatasetPath=path;obj.Simulator=lmzmodels.slip_quad_load.MultiStrideSimulator();
        end
        function evaluation=evaluate(obj,u,p,context,includeSimulation)
            ...
            diagnostics=struct('LegacyEquivalent',true,'HiddenEventTimeSolve',false, ...
