classdef ParameterSchema
    ...
    methods (Static)
        function schema = create()
            ...
            roles = repmat({'physical'}, size(names));
            energyEffects = repmat({'state_dependent'}, size(names));
            energyEffects{5} = 'unknown';
            notes = {'','','','', ...
            ...
            for index = 1:numel(names)
                ...
                specs(end+1,1) = lmz.schema.VariableSpec(names{index}, ... %#ok<AGROW>
                    ...
                    'Role',roles{index},'EnergyEffect',energyEffects{index}, ...
                    'Note',notes{index});
            end
