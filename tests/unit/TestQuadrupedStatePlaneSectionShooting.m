classdef TestQuadrupedStatePlaneSectionShooting < matlab.unittest.TestCase
    methods (Test)
        function descendingPlaneCorrectsToTransverseReturn(testCase)
            ...
            problem=model.createProblem('periodic_orbit', ...
                localConfiguration('descending_y_0_9'));
            ...
            solved=lmz.services.SolveService().solve(problem,seed, ...
                localOptions(),lmz.api.RunContext.synchronous(1110));
            ...
            testCase.verifyNumElements(solved.Solution.DecisionValues,21);
        end
    end
end
