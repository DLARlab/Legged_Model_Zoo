classdef TestNStrideSimulationBoundaries < matlab.unittest.TestCase
    ...
    methods (Test)
        function tutorialReturnsStrictThreeStrideTrajectory(testCase)
            ...
            testCase.verifyTrue(isnumeric( ...
                result.Diagnostics.StrideBoundaries));
            testCase.verifyEqual( ...
                numel(result.Diagnostics.PerStrideBoundaries),3);
            intervals=result.Diagnostics.PerStrideBoundaries;
            testCase.verifyEqual(result.Diagnostics.StrideBoundaries, ...
                [[intervals.StartTime],intervals(end).EndTime], ...
                'AbsTol',0);
